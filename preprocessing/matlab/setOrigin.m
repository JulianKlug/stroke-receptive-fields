function coivox = clinical_setorigin(vols, coregister, modality)
...
% coregister [boolean] : coregister to template, or not
% modality : to what template should the volumes be aligned (and
% coregistered)
%Examples
