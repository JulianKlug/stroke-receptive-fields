...
# data_set = (clinical_inputs, ct_inputs, ct_label, mri_inputs, mri_lesion_GT, brain_masks, ids, param)
...
rf_hyperopt(model_name, Model_Generator, ct_inputs, ct_label, clinical_inputs, brain_masks, ids,
            feature_scaling, pre_smoothing, False, False,
